...
define gui.about = _p("""
Неудачный День - игра в жанре визуальной новеллы, разработанная Шмаковой Натальей и Гржибовским "Arkanium77" Никитой.
Эта игра призвана научить пользователя основам безопасности жизнедеятельности в современном городе, а если он с ними знаком, то помочь вспомнить.
Сюжет нашей визуальной новеллы можно отнести к жанрам «Обучающая», «Комедия», «Пародия», «Романтика».

При разработке игры были использованы изображения из игр {a=https://illusseed.itch.io/asagao-academy-normal-boots-club}Asagao Academy: Normal Boots club{/a} (бесплатной игры авторства Illus Seed Games) и
 {a=http://5pb.jp/games/steam/steinsgate/en/}Steins;Gate {/a} (коммерческой игры 5pb Studio). Все права на них принадлежат вышеупомянутым авторам, а данный проект, созданый исключительно в образовательных целях, никогда не будет использоваться для получения дохода.
""")
...
define config.sample_sound = "sounds/sound/tapestop.mp3"
...
define config.main_menu_music = "sounds/music/bad.mp3"
...
define config.save_directory = "OBZH-1525451371"
